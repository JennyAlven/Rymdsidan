url = `https://newsapi.org/v2/everything?q=space AND exploration &sources=new-scientist,national-geographic,bbc-news,the-new-york-times&apiKey=${key}`

const recievedNews2 = (newsdata) => {
    const articlesDiv = document.querySelector(".innerruta2")
